export const translations = {
  Ko: {
    ...
    notification: {
      ...
      deleteAll: "모두 삭제",
      loadMore: "더보기",
      postComment: "게시글에 댓글을 남겼습니다.",
      postLike: "게시글에 좋아요를 눌렀습니다.",
      commentReply: "댓글에 대댓글을 남겼습니다.",
    },
    auth: {
  ...
  En: {
    ...
    communityPage: {
      ...
      reply: "Reply",
      cancelReply: "Cancel",
      myScraps: "Saved Posts",
      noScraps: "No saved posts yet.",
    },
    notification: {
      title: "Notifications",
  ...
  Jp: {
    ...
    notification: {
      ...
      deleteAll: "すべて削除",
      loadMore: "もっと見る",
      postComment: "さんが投稿にコメントしました。",
      postLike: "さんが投稿にいいねしました。",
      commentReply: "さんがコメントに返信しました。",
    },
    auth: {
